...
# Initialize FastMCP server for Quix Deployments
mcp = FastMCP("quix_deployments")
...
if __name__ == "__main__":
    ...
    parser = argparse.ArgumentParser(description='Run Quix Deployments MCP SSE-based server')
    ...
    logger.info(f"Starting Quix Deployments MCP server on {args.host}:{args.port}")
